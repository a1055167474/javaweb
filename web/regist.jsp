...
<body>
	...
	<form action="loginServlet3" method="post">
        ...
        <div class="form-item">
            <input name="username" type="text" autocomplete="on" placeholder="请输入注册用户名">
        </div>
        <div class="form-item">
            <input name="password" type="password" autocomplete="off" placeholder="请输入注册密码">
        </div>
        <div class="form-item"><button formaction="registServlet" type="submit">立即注册</button></div>
	</form>
        <div class="form-item">
            <a href="Login.jsp"><button>已有账户立即登录</button></a>
        </div>
    </div>
    </body>
</html>
